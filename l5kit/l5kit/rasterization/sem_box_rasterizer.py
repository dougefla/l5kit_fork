...
class SemBoxRasterizer(Rasterizer):
    ...
    def rasterize(
        ...
        return im_out_box, im_out_sem

    def to_rgb(self, in_im_box: np.ndarray,in_im_sem: np.ndarray, **kwargs: dict) -> np.ndarray:
        im_out_box = self.box_rast.to_rgb(in_im_box, **kwargs)
        # cv2.imwrite("/home/fla/workspace/l5kit_fork/output/box.png",im_out_box)
        im_out_sem = self.sem_rast.to_rgb(in_im_sem, **kwargs)
        # cv2.imwrite("/home/fla/workspace/l5kit_fork/output/sem.png",im_out_sem)
